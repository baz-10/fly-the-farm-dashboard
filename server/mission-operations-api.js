...
function checkedFailure(req, result) {
  ...
  if (['MISSION_NOT_AUTHORISED', 'JSA_DAY_REVIEW_REQUIRED', 'MISSION_PACKAGE_STALE',
    ...
    'MISSION_DAY_CHEMICAL_RECONCILIATION_REQUIRED', 'MISSION_FINAL_SIGNOFF_IMMUTABLE',
    ...
    'JOB_MISSIONS_NOT_SIGNED_OFF', 'JOB_MISSION_AUTHORITY_UNRESOLVED', 'JOB_MISSIONS_REQUIRED', 'JOB_VERSION_CONFLICT',
