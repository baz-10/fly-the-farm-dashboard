...
vi.mock('../contexts/MaintenanceContext',()=>({useMaintenance:()=>({assets:[
 ...
 {id:'t1',tenantId:'t',sourceId:'t1',scope:'fleet',assetClass:'truck',name:'Spray Truck',status:'serviceable',readings:{},createdAt:'x',updatedAt:'x'}],records:[{id:'r1',assetId:'a1',type:'defect',title:'Motor vibration',description:'',status:'reported',occurredAt:'2026-07-20',createdAt:'x',createdBy:'p',createdByName:'PIC',createdByRole:'contractor',affectsServiceability:true,resultingServiceability:'unserviceable',attachments:[]}],schedules:[],auditEvents:[],submitRecord:vi.fn(),isLoading:false})}));
