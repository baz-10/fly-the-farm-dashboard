...
export const REACHABLE_PRODUCT_ROUTES = [
  ...
  { path: '/apply', moduleCode: 'organisation-onboarding', workflowCode: 'application-review' },
  { path: '/onboarding/accept', moduleCode: 'organisation-onboarding', workflowCode: 'invitation-provisioning' },
  ...
  { path: '/getting-started', moduleCode: 'organisation-onboarding', workflowCode: 'getting-started' },
