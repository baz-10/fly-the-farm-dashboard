...
export const ASSET_WORKSPACE_SECTIONS=[['overview','Overview'],['maintenance','Maintenance'],['components','Components'],['parts-fluids','Parts & Fluids'],['service-kits','Service Kits'],['defects','Defects'],['documents','Documents'],['history','History']] as const;
