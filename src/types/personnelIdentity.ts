...
export interface PersonnelIdentityCandidate{internalUserId:string;membershipId:string;displayName:string;email:string|null;roleCode:string;seatStatus:string;alreadyLinkedPersonnelId:string|null;duplicateIndicators:DuplicateIdentitySignal[];}
