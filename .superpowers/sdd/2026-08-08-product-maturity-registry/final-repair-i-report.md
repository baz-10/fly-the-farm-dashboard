...
- Quote Detail preserves parent record controls while the operative Print/export action is constrained by `quotes/pdf-export`.
...
- GREEN: the combined directly affected batch passed 6 suites and 37 tests; the final Mission Authorisation suite passed 4 tests, including pack refresh and constrained zero-call behavior.
